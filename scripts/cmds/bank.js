...
case "deposit":
  if (isNaN(amount) || amount <= 0) {
    return message.reply("╔════ஜ۩۞۩ஜ═══╗\n\n[🏦 𝗕𝗮𝗻𝗸 🏦]\n\n❏𝗽𝗹𝗲𝗮𝘀𝗲 𝗲𝗻𝘁𝗲𝗿 𝗮 𝘃𝗮𝗶𝗹𝗱 𝗮𝗺𝗼𝘂𝗻𝘁 𝘁𝗼 𝗱𝗲𝗽𝗼𝘀𝗶𝘁 🔁•\n\n╚════ஜ۩۞۩ஜ═══╝");
  }


  if (bankBalance >= 1e104) {
    return message.reply("╔════ஜ۩۞۩ஜ═══╗\n\n[🏦 𝗕𝗮𝗻𝗸 🏦]\n\n❏𝗬𝗼𝘂 𝗰𝗮𝗻𝗻𝗼𝘁 𝗱𝗲𝗽𝗼𝘀𝗶𝘁 𝗺𝗼𝗻𝗲𝘆 𝘄𝗵𝗲𝗻 𝘆𝗼𝘂𝗿 𝗯𝗮𝗻𝗸 𝗯𝗮𝗹𝗮𝗻𝗰𝗲 𝗶𝘀 𝗮𝗹𝗿𝗲𝗮𝗱𝘆 𝗮𝘁 $1e104 ✖️•\n\n╚════ஜ۩۞۩ஜ═══╝");
  }

  if (userMoney < amount) {
    return message.reply("╔════ஜ۩۞۩ஜ═══╗\n\n[🏦 𝗕𝗮𝗻𝗸 🏦]\n\n❏𝗬𝗼𝘂 𝗱𝗼𝗻'𝘁 𝗵𝗮𝘃𝗲 𝘁𝗵𝗲 𝗿𝗲𝗾𝘂𝗶𝗿𝗲𝗱 𝗮𝗺𝗼𝘂𝗻𝘁 𝘁𝗼 𝗱𝗲𝗽𝗼𝘀𝗶𝘁 ✖️•\n\n╚════ஜ۩۞۩ஜ═══╝");
  }
...
fs.writeFileSync(bankDataPath, JSON.stringify(bankData), "utf8");
  ...
  return message.reply(`╔════ஜ۩۞۩ஜ═══╗\n\n[🏦 𝗕𝗮𝗻𝗸 🏦]\n\n❏𝗦𝘂𝗰𝗰𝗲𝘀𝘀𝗳𝘂𝗹𝗹𝘆 𝗱𝗲𝗽𝗼𝘀𝗶𝘁𝗲𝗱 $${amount} 𝗶𝗻𝘁𝗼 𝘆𝗼𝘂𝗿 𝗯𝗮𝗻𝗸 𝗮𝗰𝗰𝗼𝘂𝗻𝘁 ✅•\n\n╚════ஜ۩۞۩ஜ═══╝`);
break;
...
case "withdraw":
  ...
  if (isNaN(amount) || amount <= 0) {
    return message.reply("╔════ஜ۩۞۩ஜ═══╗\n\n[🏦 𝗕𝗮𝗻𝗸 🏦]\n\n❏𝗽𝗹𝗲𝗮𝘀𝗲 𝗲𝗻𝘁𝗲𝗿 𝘁𝗵𝗲 𝗰𝗼𝗿𝗿𝗲𝗰𝘁 𝗮𝗺𝗼𝘂𝗻𝘁 𝘁𝗼 𝘄𝗶𝘁𝗵𝗱𝗿𝗮𝘄 😪•\n\n╚════ஜ۩۞۩ஜ═══╝");
  }

  if (userMoney >= 1e104) {
    return message.reply("╔════ஜ۩۞۩ஜ═══╗\n\n[🏦 𝗕𝗮𝗻𝗸 🏦]\n\n❏𝗬𝗼𝘂 𝗰𝗮𝗻𝗻𝗼𝘁 𝘄𝗶𝘁𝗵𝗱𝗿𝗮𝘄 𝗺𝗼𝗻𝗲𝘆 𝘄𝗵𝗲𝗻 𝘆𝗼𝘂𝗿 𝗯𝗮𝗹𝗮𝗻𝗰𝗲 𝗶𝘀 𝗮𝗹𝗿𝗲𝗮𝗱𝘆 𝗮𝘁 1𝗲104 😒•\n\n╚════ஜ۩۞۩ஜ═══╝");
  }
