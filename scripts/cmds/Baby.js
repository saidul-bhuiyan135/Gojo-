...
module.exports.onStart = async ({ api, event, args, usersData }) => {
  ...
  try {
    ...
    // Default message handler when not using special commands:
...
module.exports.onChat = async ({ api, event, message }) => {
  try {
    ...
    // Special check for "bby tmr boss ke"
    if(body.includes("bby tmr boss ke")) {
      return api.sendMessage("𝗔𝗥𝗜𝗬𝗔𝗡 𝗦𝗔𝗜𝗗𝗨𝗟 😼", event.threadID, event.messageID);
    }
