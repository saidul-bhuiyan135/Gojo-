...
module.exports = {
	...
	onStart: async function ({ message, args, event, threadsData, role }) {
		...
		if (args.length === 0) {
			...
			msg += `🪐| 𝙎𝘼𝙄𝘿𝙐𝙇 𝘼𝙄 | 終`; // its not decoy so change it if you want 

			const helpListImages = [
				'https://i.imgur.com/n58XqRk.gif',

				'https://i.imgur.com/8d6WbRJ.gif',

				'https://i.imgur.com/M4luPbE.gif',

				'https://i.imgur.com/8Mg0Cmr.mp4',

				'https://i.imgur.com/DU7eM0L.mp4',
													'https://i.imgur.com/OSWG34k.jpeg',

				'https://i.imgur.com/cWdpNtv.gif',

				'https://i.imgur.com/n0SwyIj.gif',

				'https://i.imgur.com/1fzz7PF.mp4',
